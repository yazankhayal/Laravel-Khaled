(function ($) {
  ...
  if ($(".banner-carousel").length) {
    ...
    /*=============================================================
		...
		if ( ( $( '.estate-sync-slider-preview' ).length > 0 ) && ( $( '.estate-sync-slider-thumb' ).length > 0 ) ) {
		var sync1 = $( ".estate-sync-slider-preview" ),
			sync2 = $( ".estate-sync-slider-thumb" ),
			slidesPerPage = 6,
  ...
  /* Range Slider Active */
	$('.range-slider').nstSlider({
		...
		'value_changed_callback': function (cause, leftValue, rightValue) {
			...
			$("#price_min").val(leftValue+'-'+rightValue);
		}
	});
})(window.jQuery);
