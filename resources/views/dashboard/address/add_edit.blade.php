                                    ...
                                    <div class="tab-pane fade tab_{{$lang222->id}}" id="{{$lang222->name}}"
                                        ...
                                        <form class="ajaxForm translate" data-name="translate"
                                            ...
                                            <div class="modal-body row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="summary">{{$lang->Summary}}</label>
                                                    <textarea rows="4" class="cls   form-control"
                                                              name="summary"
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.success != null) {
                            ...
                            $("#summary_translate_" + result.success.language_id).html(result.success.summary);
                        } else {
                            $('#hp_contents_id_' + language_id).val(id);
                            $("#name_translate_" + language_id).val('');
                            $("#summary_translate_" + language_id).html('');
