                    ...
                    <div class="form-group m-form__group">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <hr>
                                <form class="ajaxForm dashboard_how_work" enctype="multipart/form-data"
                                      data-name="dashboard_how_work"
                                      action="{{route('dashboard_how_work.post_data')}}" method="post">
                                    {{csrf_field()}}
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('dashboard_how_work.index')}}" class="btn btn-default">
                                            {{$lang->Close}}
                                        </a>
                                ...
                                @foreach($langauges->where('dir','!=',$select_lan_choice->dir) as $lang222)
                                    ...
                                    <div class="tab-pane fade tab_{{$lang222->id}}" id="{{$lang222->name}}"
                                        ...
                                        <form class="ajaxForm translate" data-name="translate"
                                              action="{{route('dashboard_how_work_translate.post_data')}}" method="post">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        var other = function(x,y){
            $.ajax({
                url: "{{route('dashboard_how_work_translate.get_data_by_id')}}",
                method: "get",
                data: {
                    "id": x,
                    "language_id": y,
        ...
        var Render_Data = function () {
            $.ajax({
                url: "{{ route('dashboard_how_work.get_data_by_id') }}",
                method: "get",
                data: {},
                dataType: "json",
                success: function (result) {
